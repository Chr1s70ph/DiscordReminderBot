...
exports.run = async (client) => {
	...
	const loginMessage = new discord.MessageEmbed() //Login Embed
		...
		.setThumbnail(client.guilds.resolve(config.ids.serverID).members.resolve(config.ids.userIDS.botUserID).user.avatarURL())
		...
		.setTimestamp()
		.setFooter(`[ID] ${config.ids.userIDS.botUserID} started`, 'https://image.flaticon.com/icons/png/512/888/888879.png');
